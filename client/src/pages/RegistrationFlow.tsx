                    ...
                    <form onSubmit={handleOTPSubmit}>
                        ...
                        >
                            ...
                            <motion.a
                                ...
                                className={`text-sm font-medium flex items-center ${resendDisabled
                        ...
                        <motion.button
                            ...
                            className={`w-full py-3 rounded-lg font-semibold cursor-pointer uppercase text-gray-50 shadow-md transition-all ${isVerifying
