...
const VenueBookingCalendar = () => {
  ...
  const handleProceed = () => {
    if (selectedDate) {
      ...
      navigate(
        `/confirm-area-booking?areaId=${areaId}&startTime=${encodeURIComponent(
          startTime
        )}&endTime=${encodeURIComponent(endTime)}&totalPrice=${price}`
      );
    }
  };
            ...
            {selectedDate && (
              <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <h4 className="font-semibold text-blue-800 mb-2 text-lg">
                  Full Day Booking Details
                </h4>
                <p className="text-blue-700">
                  This venue is available for fixed hours only. Your booking
