  ...
  return (
    <>
      <aside className="fixed top-0 left-0 flex flex-col p-4 bg-white text-black h-full transition-all duration-300 min-w-[300px]">
        ...
        <div className="border-b border-purple-200 pb-4 mb-4 flex items-center justify-between w-full">
        ...
        {/* Admin profile */}
        <div className="p-2 pb-4 mb-4 bg-purple-100 rounded-md shadow-sm shadow-purple-300 w-full">
